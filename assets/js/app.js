  ...
  return `<article class="card projectCard">
    ...
    <div class="cardBody">
      ...
      <div class="roiRow compactRoi">
        ...
        <div class="roiBox"><b>${percent(item.conservativeROI)}</b><span>${tr('conservativeRoi')}</span></div>
      </div>
